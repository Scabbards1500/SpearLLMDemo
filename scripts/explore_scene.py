"""Explore a SPEAR scene: print spawn pose, sample nav-mesh goals, optional visual markers.

Usage:
    conda activate spearenv
    cd d:\\python\\SpearLLMDemo
    python scripts/explore_scene.py
    python scripts/explore_scene.py --scene apartment
    python scripts/explore_scene.py --scene debug --spawn-markers
"""
...
SCENES = {
    ...
    "debug": "/Game/SPEAR/Scenes/debug_0000/Maps/debug_0000.debug_0000",
...
def main() -> None:
    ...
    print("\nNext: python scripts/demo_hardcoded.py  (watch agent_view + game window)")
    print("Tip: use --scene apartment in demo once we wire scene selection.\n")
